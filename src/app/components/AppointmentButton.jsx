...
import animationData from '../lottie/calender.json'; // Ensure the path is correct
import Link from 'next/link';

function AppointmentButton ({link="https://calendly.com/service-probeyservices/30min",name="Book free consultation"}) {
  return (


    <Link href={link} className="btn-animate_submit rounded-pill">
    {/* Text Elements */}
