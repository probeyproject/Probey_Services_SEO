        ...
        <>
            <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
                <div className="col-12 text-center">
                    {/* Subtitle */}
                    <p className="text-uppercase text-primary">BEST IOS APP DEVELOPMENT COMPANY IN INDIA</p>
                    ...
                    <h3 className="mt-3" style={{ color: 'black', fontWeight: 600, fontSize: '40px', textDecoration: 'upperCase' }}>
                        ...
                        <span style={{ color: '#9F9F9F', fontWeight: 600, fontSize: '40px' }}>
                            User Friendly iOS Experiences for More Engagement
                        </span>
                    </h3>

                    {/* Description */}
                    <p className="mt-4" style={{ textAlign: 'center', fontSize: "15px", lineHeight: "1.7" }}>
                        At Probey Services, a leading <b>iOS app development company</b>, we create iOS apps that are smooth, powerful, and perfectly suited to your business needs. As a part of our <b>iOS Application development services</b>, our skilled developers use the latest tools like Swift and Objective-C to build apps that are both easy to navigate and engaging. As an experienced<b>iOS app development agency</b>, we focus on ensuring your app performs beautifully on iPhones, iPads, and all Apple devices, delivering the best experience for your users.
                    </p>
