...
import Awards from "@/app/components/CommonAwards";
...
const caseStudies = [
    ...
    },
    {
      ...
      data: [
        {
          title: "Challenge",
          description: "Salestancy, a sales consultancy based in Noida, needed a solution to manage their sales pipeline more effectively and improve client relationships. Their existing system was not meeting their needs for lead management and performance tracking."
        },
        {
          title: "Solution",
          description: "Probey Services, the best web application development companies in Delhi NCR, developed a CRM system with features for lead tracking, reporting, and analytics. We ensured the CRM was user-friendly and integrated smoothly with Salestancy’s existing tools."
        },
        {
          title: "Outcome",
          description: "The new CRM system from Probey Services improved sales performance by 30% and increased revenue by 20%. This solution helped Salestancy better manage their sales pipeline and achieve their business goals. As a top web application development company in Delhi NCR, Probey Services delivered a CRM solution that significantly impacted Salestancy’s operations and success."
        }
      ],
      button: true
    }
...
function page() {
  ...
  <p className="text-uppercase text-primary">
    User-Friendly Web Experiences That Drive Engagement
  </p>
  ...
  >
    ...
    >
      Designs That Impress, Even Offline
    </span>
  </h3>
  ...
  >
    <strong>Probey Services</strong> specializes in creating custom web designs that are not only functional but also aesthetically pleasing, ensuring a seamless user experience. We focus on designs that reflect your brand’s identity and resonate with your audience, whether they’re online or offline.
  </p>
            ...
            <div className="row">
              <div className="col-md-6 border-right mb-3 mb-md-0">
                <div className="">
                  ...
                  <strong>Probey Services</strong> specializes in providing expert web development solutions that are both highly functional and user-friendly. We create responsive, scalable, and secure websites that are designed to meet your business needs. Our development process ensures seamless user experiences, while integrating the latest technologies to build websites that not only work well but also drive engagement—whether viewed online or offline.
                  ...
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        >
                          <strong>Probey Services</strong>  creates custom web applications tailored to your specific business needs, ensuring functionality, security, and scalability.
                        </p>
                      </div>
                    </div>
                  </div>
