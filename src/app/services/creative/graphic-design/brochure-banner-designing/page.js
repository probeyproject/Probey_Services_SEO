  ...
  const iconBoxes = [
    {
      ...
      description: "Understanding the purpose and target audience for the brochures and banners."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-7.png",
      title: "Concept Development",
      description: "Developing design concepts that align with your brand and message."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-8.png",
      title: "Design",
      description: "Creating visually appealing designs that effectively communicate your message."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-9.png",
      title: "Feedback and Refinement",
      description: "Incorporating client feedback and refining the designs."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-10.png",
      title: "Finalization",
      description: "Finalizing the designs and preparing them for print or digital use."
    },
  ];
    ...
    <>
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          Banner Design Company in Noida
</p>
          ...
          Probey Services provides professional brochure and banner design services to help you promote your products and services effectively. Our creative designs capture attention and communicate your message clearly and compellingly.
          </p>
      ...
      <div className='container-fluid py-5' style={{ backgroundColor: "#f4f4ff" }}>
        <div className="text-center mb-5">
          ...
          <h1 className="fw-bolder">Brochure & Banner Designing
Strategies
            ...
            <div className="row">
              <div className="col-md-6 border-right mb-3 mb-md-0" >
                <div className="">
                  ...
                  <span className="mt-2 w-75">Probey Services offers exceptional brochure and banner design services in Delhi NCR, tailored to amplify your brand’s visibility and create a lasting impression. Our creative team designs eye-catching, strategically aligned brochures and banners that capture your brand’s essence, positioning us as one of the top design providers in India. We go beyond aesthetics, ensuring each design communicates your brand message effectively, making it easy for potential customers to recognize, trust, and connect with your brand. More than just visuals, our focus is on converting attention into loyalty, empowering your brand’s growth. Let us elevate your brand presence with impactful brochure and banner designs that turn your vision into measurable, lasting success.</span>
                </div>
              </div>
                  ...
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        >
       Probey Services creates eye-catching and informative brochures that communicate your brand’s message clearly and effectively.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        Engaging Banner Design
                        </span>
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >We design high-quality banners that capture attention, whether for digital use or physical displays, ensuring maximum visibility and impact.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 mt-4">
                    <div className="grid-item">
                      <div className="">
                        ...
                        <span className="text-capitalize text-wrap display-7 mb-4">
                        Tailored Design for Your Audience
                        </span>
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >Our design team creates brochures and banners that are customized to resonate with your target audience, enhancing engagement.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >Probey Services provides both print-ready and digital formats, ensuring that your materials are versatile and ready for any platform or distribution channel.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >We work with you through every step of the design process, ensuring the final product aligns with your vision and goals.
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-md-8'>
              ...
              Ready to take your business to the next level? Discover new possibilities with the best blog and article writing solutions. Let us help you grow, innovate, and achieve excellence in ways you never thought possible.
              </p>
            </div>
