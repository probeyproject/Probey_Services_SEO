...
// import Benifits from "@/app/components/Benifits";
  ...
  const iconBoxes = [
    {
      ...
      description: "Understanding the product specifications and requirements.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-7.png",
      title: "Design Concepts",
      description: "Developing design concepts for the product boxes",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-8.png",
      title: "Creation",
      description: "Designing durable and visually appealing product boxes.",
    },
    {
    ...
    },
    {
      ...
      title: "Production",
      description: "Finalizing the designs and preparing them for production.",
    },
    // {
    ...
    <>
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          Package Designing Company in Noida
          {/* Title */}
          <h3
            className="mt-3"
            style={{
          ...
          >
            <strong>Probey Services</strong> offers professional product box design services to create attractive and durable packaging for your products. Our designs are tailored to your brand and product specifications.
          </p>
                  ...
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        >
                          <strong>Probey Services</strong> specializes in creating custom packaging designs that highlight your product’s features while enhancing your brand’s visual appeal.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          We balance functionality with aesthetics, ensuring that your packaging not only looks great but is also practical and protective.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          We provide 3D mockups of packaging designs, allowing you to visualize the final product before production and make necessary adjustments.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          Our packaging designs maintain consistent branding across all materials, helping your products stand out on the shelves and stay recognizable to customers.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          Probey Services can help you incorporate sustainable and eco-friendly packaging materials, reducing your environmental impact.
                        </p>
                      </div>
                    </div>
                  </div>
