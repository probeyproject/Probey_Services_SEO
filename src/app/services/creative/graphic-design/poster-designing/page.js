  ...
  const iconBoxes = [
    {
      ...
      description: "Understanding the goals and target audience for the flyers and posters."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-7.png",
      title: "Design Concepts",
      description: "Developing design concepts that align with your brand and event theme."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-8.png",
      title: "Creation",
      description: "Designing engaging and visually appealing flyers and posters."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-9.png",
      title: "Feedback and Iteration",
      description: "Incorporating client feedback and making necessary adjustments."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-10.png",
      title: "Final Production",
      description: "Finalizing the designs and preparing them for print or digital distribution."
    },
  ];
    ...
    <>
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          Poster Design Company in Noida
</p>
          ...
          Probey Services offers creative flyer and poster design services to help you promote your events, products, and services. Our designs are tailored to capture attention and drive engagement.
          </p>
      ...
      <div className='container-fluid py-5' style={{ backgroundColor: "#f4f4ff" }}>
        <div className="text-center mb-5">
          ...
          <h1 className="fw-bolder">Flyer & Poster Designing
Strategies
            ...
            <div className="row">
              <div className="col-md-6 border-right mb-3 mb-md-0" >
                <div className="">
                  ...
                  <span className="mt-2 w-75">Probey Services provides professional flyer and poster design services in Delhi NCR, crafted to enhance your brand’s visibility and make a lasting impact. Our creative team designs unique, eye-catching flyers and posters that capture the essence of your brand and communicate your message effectively, establishing us as a leading design provider in India. Each design is visually compelling and strategically crafted to resonate with your target audience, making it easy for potential customers to recognize and engage with your brand. More than just promotional materials, our designs are crafted to convert interest into loyalty, supporting sustainable brand growth. Let us elevate your brand presence with powerful flyer and poster designs that turn your message into an impactful, measurable asset.</span>
                </div>
              </div>
                  ...
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        High-Impact Flyer Design
                        </span>
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                      Probey Services designs visually appealing flyers that effectively communicate your marketing message, driving customer interest and action.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >We create large-format posters that are ideal for events, promotions, or brand awareness campaigns, designed to grab attention and inspire engagement.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >Whether for an event, product launch, or promotional sale, our team tailors your flyers and posters to maximize impact and relevance.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 mt-4">
                    <div className="grid-item">
                      <div className="">
                        ...
                        <span className="text-capitalize text-wrap display-7 mb-4">
                        Brand Optimized for Print & Digital
                        </span>
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >We provide high-resolution files optimized for both print and digital use, ensuring that your designs look great across all platforms. ensure that your logo aligns with your overall brand identity, maintaining consistency across all your marketing materials.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >Probey Services ensures a quick turnaround time and offers multiple revisions to ensure you’re completely satisfied with the final design.
                        </p>
                      </div>
                    </div>
                  </div>
