...
function Brand() {
  ...
  const iconBoxes = [
    ...
    },
    {
      ...
      description: "Creating a consistent brand theme, including color palettes, typography, and visual style."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-8.png",
      title: "Strategy Planning",
      description: "Developing a comprehensive branding strategy that includes messaging, positioning, and marketing tactics."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-9.png",
      title: "Implementation",
      description: "Rolling out the brand theme and strategy across all marketing channels."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-10.png",
      title: "Monitoring",
      description: "Continuously monitoring the effectiveness of the brand strategy and making adjustments as needed."
    },
  ];
    ...
    <>
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          Probey Services offers comprehensive brand theme and strategy services to help you build a cohesive and compelling brand image. Our team works with you to develop a strategic plan that aligns with your business goals and resonates with your audience.
          </p>
      ...
      <div className='container-fluid py-5' style={{ backgroundColor: "#f4f4ff" }}>
        <div className="text-center mb-5">
          ...
          <h1 className="fw-bolder">Brand Theame
Strategies
            ...
            <div className="row">
              <div className="col-md-6 border-right mb-3 mb-md-0" >
                <div className="">
                  ...
                  <span className="mt-2 w-75">Probey Services provides comprehensive brand theme and strategy services in Delhi NCR, dedicated to building a cohesive and impactful brand identity that resonates with your audience. Our expert team crafts unique, memorable brand themes that capture your brand’s essence and establish a lasting impression, positioning us among the top branding agencies in India. We go beyond visuals, creating strategically aligned brand themes that communicate your message consistently across all platforms, making it easy for potential customers to recognize, trust, and connect with your brand. More than just branding, we focus on converting interest into loyalty, empowering sustainable growth. Let us elevate your brand identity with a powerful strategy that turns your online presence into measurable, lasting success.</span>
                </div>
              </div>
                  ...
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        >
             Probey Services develops a cohesive brand strategy that reflects your business goals and ensures consistency across all platforms.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        Visual Brand Identity Creation
                        </span>
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >We create a strong visual identity, including color schemes, typography, and design elements, that reflects your brand’s core message and values.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >Our team ensures that your brand’s messaging remains consistent across all marketing channels, reinforcing your brand image.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >We provide a detailed brand guidelines document that outlines the correct use of logos, colors, fonts, and other visual elements.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >Probey Services offers long-term brand management to ensure that your visual identity remains consistent and effective as your business grows.
                        </p>
                      </div>
                    </div>
                  </div>
