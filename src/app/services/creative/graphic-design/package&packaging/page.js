  ...
  const iconBoxes = [
    {
      ...
      title: "Product and Brand Analysis",
      description: "Understanding the product features and brand identity.",
    },
    {
    ...
    },
    {
      ...
      title: "Design",
      description: "Developing detailed packaging designs.",
    },
    {
    ...
    <>
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          >
            <strong>Probey Services</strong> specializes in creating attractive and functional packaging designs that enhance your product’s appeal. Our designs are tailored to reflect your brand and attract customers.
          </p>
