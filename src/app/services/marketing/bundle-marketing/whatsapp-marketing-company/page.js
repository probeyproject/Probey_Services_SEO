  ...
  const iconBoxes = [
    {
      ...
      description: "Identifying target audience segments for personalized messaging.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-7.png",
      title: "Content Creation",
      description:
        "Developing engaging and multimedia-rich messages",
    },
    {
      ...
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          >
            ...
            >
              Engage Your Audience, Grow Your Business
            </span>
          </h3>
          ...
          >
           <strong>Probey Services provides WhatsApp marketing services</strong> to help you connect with your audience on this popular messaging platform.
          </p>
              ...
              <div className="col-md-6 border-right mb-3 mb-md-0">
                <div className="">
                  ...
                  <span className="mt-2 w-75">
                    <strong>
                      {" "}
                      Probey Services offers the best WhatsApp marketing services in Delhi NCR{" "}
                    </strong>{" "}
                    to enhance your business's online presence. Our expertise in
                    WhatsApp marketing strategy and targeted campaigns makes us
                    ...
                    on converting contacts into loyal customers, helping you grow
                  ...
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        >
                          We offer personalized bulk messaging campaigns that allow you to reach thousands of customers with tailored content, improving engagement rates.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          Probey Services integrates smart chatbots into your WhatsApp marketing to provide instant customer support and answer common inquiries, enhancing user experience.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                         We help you create engaging WhatsApp messages that include images, videos, and links to capture your audience’s attention and increase click-through rates.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                         Probey Services provides detailed reporting on message delivery rates, read rates, and responses, helping you gauge the effectiveness of your WhatsApp campaigns.
                        </p>
                      </div>
                    </div>
                  </div>
