  ...
  const iconBoxes = [
    {
      ...
      description: "Segmenting your email list for targeted messaging.",
    },
    {
    ...
    },
    {
      ...
      title: "Analytics",
      description: "Monitoring and analyzing campaign performance.",
    },
    // {
      ...
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          >
            ...
            >
              Ignite Engagement with Every Email
            </span>
          </h3>
          ...
          >
            <strong>Probey Services</strong> offers comprehensive email marketing services to help you reach your audience with targeted and personalized email campaigns.
          </p>
              ...
              <div className="col-md-6 border-right mb-3 mb-md-0">
                <div className="">
                  ...
                  <span className="mt-2 w-75">
                    <strong>
                      {" "}
                      Probey Services offers the best email marketing services in Delhi NCR{" "}
                    </strong>{" "}
                    to enhance your business's online presence. Our expertise in
                    email marketing strategy and targeted campaigns makes us
                    one of the leading advertising companies in India, ensuring
                    that you reach a wider audience and connect with potential
                    customers effectively. We don’t just drive engagement; we focus
                    on converting subscribers into loyal customers, helping you grow
