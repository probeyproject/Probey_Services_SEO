  ...
  const iconBoxes = [
    {
      ...
      description: "Identifying high-traffic keywords relevant to your products.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-7.png",
      title: "Listing Optimization",
      description:
        "Optimizing product titles, descriptions, and tags.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-8.png",
      title: "Content Enhancement",
      description: "Improving the quality of product descriptions and visuals.",
    },
    
    {
      ...
      description:
        "Creating backlinks to increase product authority.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-11.png",
      title: "Monitoring",
      description:
        "Regularly monitoring and updating SEO strategies for sustained performance.",
    },
  ];
    ...
    <>
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          >
          <strong>Probey Services</strong> specializes in marketplace SEO, helping your products rank higher in search results on various online marketplaces. Our SEO strategies are tailored to increase your product visibility and drive more traffic to your listings.
                  ...
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        >
                          Probey Services ensures that your product listings are fully optimized with relevant keywords, increasing your products’ visibility on search engines and within the marketplace.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                         We provide professional product images that meet the marketplace standards, showcasing your products in the best possible light.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                         Our team crafts informative and engaging product descriptions that highlight key features and benefits, driving purchase decisions.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                         We monitor competitor pricing and market trends to ensure your products are priced competitively, increasing sales opportunities
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                        Probey Services synchronizes your product listings across multiple marketplaces, ensuring consistency and accuracy for all platforms.
                        </p>
                      </div>
                    </div>
                  </div>
