  ...
  const iconBoxes = [
    {
      ...
      description: "We take the time to understand your e-commerce business model and what you need to succeed.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-7.png",
      title: "Platform Selection",
      description:
        "We help you choose the best e-commerce platform that fits your business perfectly.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-8.png",
      title: "Inventory Management",
      description: "We set up smart inventory solutions to keep your stock organized and accessible.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-9.png",
      title: "Order Processing",
      description: "We streamline your order processing to ensure quick and accurate fulfillment.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-10.png",
      title: "Customer Support",
      description: "We provide top-notch customer support to make sure your shoppers have a great experience. Our best e-commerce management solutions include comprehensive customer care to enhance satisfaction.",
    },
    // {
    ...
    <>
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          BEST E-COMMERCE WEBSITE DEVELOPMENT AGENCY IN NOIDA
          </p>
          ...
          >
          At <strong>Probey Services</strong>, we provide end-to-end e-commerce management services to streamline your online store operations and maximize efficiency. Our goal is to make your online store run smoothly and efficiently, creating a seamless shopping experience that turns visitors into loyal customers.
          </p>
                  ...
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        >
                          Probey Services ensures seamless inventory management across all your e-commerce platforms, making sure your product stock is up-to-date and synced in real-time.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                         We manage the entire order fulfillment process, from order placement to shipping, ensuring timely and accurate delivery, leading to better customer satisfaction.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 mt-4">
                    <div className="grid-item">
                      <div className="">
                        ...
                        <span className="text-capitalize text-wrap display-7 mb-4">
                        Marketplace Account Handling
                        </span>
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                         Probey Services will take care of your day-to-day marketplace operations, including account updates, promotions, and customer inquiries to enhance your presence on platforms like Amazon, eBay, and more.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                         We help you set up marketplace-specific promotions and discounts to boost sales and attract more customers.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                         We handle customer interactions, returns, and feedback management, helping you maintain a positive seller rating across marketplaces.
                        </p>
                      </div>
                    </div>
                  </div>
