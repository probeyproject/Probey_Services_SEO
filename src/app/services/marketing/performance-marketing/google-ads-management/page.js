  ...
  const iconBoxes = [
    {
      ...
      description:
        "Identifying high-performing keywords for your ads",
    },
    {
    ...
    },
    {
      ...
      description:
        "Setting up, managing, and optimizing Google Ads campaigns.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-9.png",
      title: "Performance Tracking",
      description:
        "Monitoring ad performance and making data-driven adjustments.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-10.png",
      title: "Reporting",
      description:
        "Providing comprehensive reports on campaign results."
    },
    // {
    ...
    <>
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          >
            <strong>Probey Services specializes in Google Ads management</strong>, helping you create effective ad campaigns that reach your target audience and drive results.
          </p>
            ...
            <div className="row">
              <div className="col-md-6 border-right mb-3 mb-md-0">
                <div className="">
                  ...
                  <strong>
                      {" "}
                      Probey Services offers the best Google Ads management
                  ...
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        >
                          <strong>Probey Services</strong> will set up and optimize your Google Ads campaigns, ensuring they are structured for maximum visibility across search and display networks.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          We implement advanced bidding techniques such as Target CPA and ROAS to maximize the efficiency of your ad spend and improve overall campaign performance.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          We continuously research and adjust keywords to ensure your ads stay competitive, reducing your cost-per-click and increasing relevancy.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                         Probey Services helps you reconnect with potential customers through tailored remarketing ads, increasing the likelihood of conversions.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          We set up conversion tracking to monitor the actions users take after interacting with your ads, giving you clear insight into your ROI.
                        </p>
                      </div>
                    </div>
                  </div>
