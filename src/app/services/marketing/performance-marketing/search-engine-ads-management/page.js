  ...
  const iconBoxes = [
    {
      ...
      description: "Understanding your target audience on Meta platforms.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-7.png",
      title: "Ad Copywriting",
      description:
        "Craft compelling ad copy that attracts clicks and conversions.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-8.png",
      title: "Bid Management",
      description: "Optimize bidding strategies to maximize ROI and stay within budget.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-9.png",
      title: "Performance Monitoring",
      description: "Continuously track and analyze ad performance to make data-driven adjustments.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-10.png",
      title: "Landing Page Optimization",
      description: "Ensure landing pages are optimized for conversions and align with ad messaging.",
    },
    // {
      ...
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          <p className="text-uppercase text-primary">
            Search Engine Ads Management Company in Noida
          </p>
          ...
          >
            ...
            >
              Maximize Your Visibility with Precision Search Ads
            </span>
          </h3>
          ...
          >
            <strong>
              Probey Services specializes in Search Engine Ads Management
            </strong>
            , helping businesses reach potential customers who are actively
            searching for products or services, driving targeted traffic and
              ...
              <div className="col-md-6 border-right mb-3 mb-md-0">
                <div className="">
                  ...
                  <span className="mt-2 w-75">
                    <strong>
                      {" "}
                      Probey Services offers the best search engine ad
                      management services in Delhi NCR{" "}
                    </strong>{" "}
                    to enhance your business's online presence. Our expertise in
                    search engine ad strategy and targeted campaigns makes us
                    one of the leading advertising companies in India, ensuring
                    that you reach a wider audience and connect with potential
                    customers effectively. We don’t just drive traffic; we focus
                    on converting clicks into loyal customers, helping you grow
                  ...
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        Customized Search Ads Strategy
                        </span>
                        <p
                          className="text-wrap fw-light"
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          At <strong>Probey Services</strong>, we create and manage tailored search ad campaigns that are designed to meet your specific business goals and drive qualified traffic to your site.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          We perform comprehensive keyword research to identify high-performing, cost-effective keywords that ensure your ads are seen by the right audience at the right time.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                         Probey Services writes compelling ad copy and performs A/B testing on multiple ad variations to optimize performance and increase click-through rates (CTR).
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          We implement tracking tools to monitor conversions, ensuring you get the best return on investment (ROI) from your search ads.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          Probey Services closely manages your ad spend to maximize effectiveness, providing you with detailed performance reports and insights.
                        </p>
                      </div>
                    </div>
                  </div>
