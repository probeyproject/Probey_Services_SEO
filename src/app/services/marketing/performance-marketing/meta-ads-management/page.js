...
const faqData = [
  ...
  },
  {
    id: "1",
    question:
      "Creative Expression Through Personal Experience in Design",
    answer: (
      <>
        <p>
  ...
  const iconBoxes = [
    {
      ...
      description:
        "Understanding your target audience on Meta platforms.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-7.png",
      title: "Ad Creation",
      description:
        "Developing engaging ad content that resonates with your audience.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-8.png",
      title: "Campaign Management",
      description:
        "Setting up, managing, and optimizing Meta Ads campaigns.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-9.png",
      title: "Performance Tracking",
      description:
        "Monitoring ad performance and refining strategies.",
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-10.png",
      title: "Reporting",
      description:
        "Providing detailed reports on ad campaign performance."
    },
    // {
    ...
    <>
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          Best Meta Ads Services in Noida
          </p>
          ...
          >
            ...
            >
              Effective Ads for Business Growth
          ...
          >
           <strong> Probey Services offers specialized Meta Ads management</strong> to help you reach your audience on Facebook and Instagram with effective ad campaigns.
          </p>
            ...
            <div className="row">
              <div className="col-md-6 border-right mb-3 mb-md-0">
                <div className="">
                  ...
                  <strong>
                      {" "}
                      Probey Services offers the best Meta Ads management
                      services in Delhi NCR{" "}
                    </strong>{" "}
                    to enhance your business's online presence. Our expertise in
                    Google Ads strategy and targeted campaigns makes us one of the
                  ...
                  <div className="col-md-6">
                    <div className="grid-item">
                      <div className="">
                        ...
                        >
                          <strong>Probey Services</strong>  creates visually compelling ad creatives that capture attention and drive engagement on both Facebook and Instagram platforms.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          We customize your ads to reach the most relevant users by defining audience segments based on interests, behavior, and demographic data.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          We perform continuous A/B testing on your ads to optimize creative performance, ensuring that the best-performing ads are consistently shown to your audience.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                         Probey Services sets up advanced tracking with Facebook Pixel, allowing for precise tracking of conversions and audience behavior, enabling retargeting.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid-item">
                      <div className="">
                        ...
                        <p
                          ...
                          style={{ fontSize: "15px", lineHeight: "1.7" }}
                        >
                          We provide detailed, easy-to-understand reports on the performance of your ad campaigns, helping you track key metrics such as impressions, clicks, and conversions.
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <div className="faq-wrapper container">
        <div className="d-flex justify-content-between align-items-center inner-container">
          <div className="d-flex flex-column col-4 p-4">
            ...
            <p className="custome-line-height p-font-size">
            Explore our Help & FAQ Center for quick answers and comprehensive guidance on using our services. Our dedicated resources are designed to support you every step of the way.
            </p>
          </div>
