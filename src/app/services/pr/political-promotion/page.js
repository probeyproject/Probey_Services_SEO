    ...
    const iconBoxes = [
        {
            ...
            description: "Developing a comprehensive PR and promotion strategy for political campaigns."
        },
        {
            icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-7.png",
            title: "Content Creation",
            description: "Creating compelling content for press releases, social media, and speeches."
        },
        {
            icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-8.png",
            title: "Media Outreach",
            description: "Engaging with media outlets and political influencers."
        },
        {
            icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-9.png",
            title: "Community Engagement",
            description: "Implementing strategies for community outreach and engagement."
        },
        {
            icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-10.png",
            title: "Monitoring and Reporting",
            description: "Tracking campaign performance and adjusting strategies as needed."
        },
        ...
        <>
            <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
                <div className="col-12 text-center">
                    {/* Subtitle */}
                    <p className="text-uppercase text-primary">Political Promotion Services in Noida</p>
                    ...
                    Political Promotion & PR
                        ...
                        Engage, Influence, Grow Your Followers
                        </span>
                    </h3>

                    {/* Description */}
                    <p className="mt-4" style={{ textAlign: 'center', fontSize: "15px", lineHeight: "1.7" }}>
                    Probey Services provides specialized political promotion and PR services to help candidates and political organizations build their public image and communicate effectively with voters. Our team creates strategic campaigns that enhance visibility and generate positive publicity.
                    </p>
            ...
            <div className='container-fluid py-5' style={{ backgroundColor: "#f4f4ff" }}>
                <div className="text-center mb-5">
                    ...
                    <h1 className="fw-bolder">Political Promotion & PR
Strategies
          ...
          <div className="row">
            <div className="col-md-6 border-right mb-3 mb-md-0" >
              <div className="">
                ...
                Probey Services provides premier political promotion services in Delhi NCR, crafted to enhance your political campaign’s online presence. With our expertise in digital marketing and SEO-driven strategies, we stand as one of the leading political advertising companies in India. We ensure your campaign ranks higher on Google, making it easier for voters to discover and connect with your message. Beyond increasing online traffic, we focus on engaging citizens and converting their interest into genuine support, helping you build a strong, impactful presence. Let us amplify your campaign's visibility and turn your online presence into meaningful, measurable results.</span>
              </div>
            </div>
                ...
                <div className="col-md-6">
                  <div className="grid-item">
                    <div className="">
                      ...
                      Targeted Political PR Campaigns
                      </span>
                      <p
                        className="text-wrap fw-light"
                        style={{ fontSize: "15px", lineHeight: "1.7" }}
                      >
                        We develop strategic political PR campaigns that focus on reaching the right demographic through digital platforms, media outlets, and social networks.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid-item">
                    <div className="">
                      ...
                      <p
                        className="text-wrap fw-light"
                        style={{ fontSize: "15px", lineHeight: "1.7" }}
                      >Probey Services helps manage the online reputation of political figures, ensuring positive public perception and mitigating any negative press.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid-item">
                    <div className="">
                      ...
                      <p
                        className="text-wrap fw-light"
                        style={{ fontSize: "15px", lineHeight: "1.7" }}
                      >Our team crafts compelling content, such as press releases, speeches, and articles, and ensures their wide distribution through relevant media outlets.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid-item">
                    <div className="">
                      ...
                      <p
                        className="text-wrap fw-light"
                        style={{ fontSize: "15px", lineHeight: "1.7" }}
                      >We create campaigns designed to engage voters through social media, email marketing, and digital ads, driving increased political awareness and support.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid-item">
                    <div className="">
                      ...
                      <p
                        ...
                        style={{ fontSize: "15px", lineHeight: "1.7" }}
                      >
                       Probey Services provides real-time crisis management for political campaigns, addressing issues as they arise to maintain a positive public image.
                      </p>
                    </div>
                  </div>
                </div>
...
export default PoliticalPromotion