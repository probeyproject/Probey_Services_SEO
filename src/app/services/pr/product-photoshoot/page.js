  ...
  const images = [
    ...
    const iconBoxes = [
        ...
        },
        {
            ...
            description: "Developing creative concepts for the photoshoot."
        },
        {
            icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-8.png",
            title: "Execution",
            description: "Conducting the photoshoot with professional equipment and techniques."
        },
        {
            icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-9.png",
            title: "Post-Production",
            description: "Editing and enhancing the photos to ensure high quality."
        },
        {
            icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-9.png",
            title: "Delivery",
            description: "Providing the final images in various formats for different uses."
        },
        ...
        <>
            <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
                <div className="col-12 text-center">
                    {/* Subtitle */}
                    <p className="text-uppercase text-primary">Product Photoshoot Services in Noida</p>
                    ...
                    Product Photoshoot
                        ...
                        Capturing Brand Success
                        </span>
                    </h3>

                    {/* Description */}
                    <p className="mt-4" style={{ textAlign: 'center', fontSize: "15px", lineHeight: "1.7" }}>
                    Probey Services specializes in professional product photoshoot services to showcase your products in the best light. Our team of experienced photographers and stylists ensures that your products look stunning and attract potential buyers.
                    </p>
            ...
            <div className='container-fluid py-5' style={{ backgroundColor: "#f4f4ff" }}>
                <div className="text-center mb-5">
                    ...
                    <h1 className="fw-bolder">Product Photoshoot
Strategies
                ...
                <div className="col-md-6">
                  <div className="grid-item">
                    <div className="">
                      ...
                      >We offer high-quality product photoshoots that capture your products in stunning detail, ideal for e-commerce and marketing purposes.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="grid-item">
                    <div className="">
                      ...
                      Customized Styling & Props
                      </span>
                      <p
                        className="text-wrap fw-light"
                        style={{ fontSize: "15px", lineHeight: "1.7" }}
                      >Probey Services styles each photoshoot with customized props and backgrounds that highlight the unique qualities of your products.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid-item">
                    <div className="">
                      ...
                      <p
                        className="text-wrap fw-light"
                        style={{ fontSize: "15px", lineHeight: "1.7" }}
                      >We deliver high-resolution images that are optimized for both digital and print use, ensuring your products look great on every platform.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid-item">
                    <div className="">
                      ...
                      <p
                        className="text-wrap fw-light"
                        style={{ fontSize: "15px", lineHeight: "1.7" }}
                      >Our team provides professional editing services, including color correction and retouching, to ensure your product images are flawless.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="grid-item">
                    <div className="">
                      ...
                      <span className="text-capitalize text-wrap display-7 mb-4 ">
                      Creative Product Showcasing
                      </span>
                      <p
                        className="text-wrap fw-light"
                        style={{ fontSize: "15px", lineHeight: "1.7" }}
                      >Probey Services creates visually striking product shots that tell a story, helping you connect with your customers and drive sales.
                      </p>
                    </div>
                  </div>
                </div>
