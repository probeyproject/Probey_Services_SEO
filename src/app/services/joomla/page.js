  ...
  const iconBoxes = [
    {
      ...
      description: "Enhance website visibility on search engines through on-page and off-page SEO techniques."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-7.png",
      title: " Content Marketing",
      description: "Create engaging and valuable content to attract and retain a clearly defined audience."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-8.png",
      title: "Social Media Marketing",
      description: "Leverage social media platforms to build brand awareness, engage with customers, and drive traffic."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-9.png",
      title: "Email Marketing",
      description: "Develop targeted email campaigns to nurture leads and convert prospects into customers."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-10.png",
      title: "Pay-Per-Click Advertising (PPC)",
      description: "Utilize PPC campaigns to generate immediate traffic and leads through targeted ads."
    },
    {
      icon: "https://noviindus.com/wp-content/uploads/2024/05/Group-11.png",
      title: "Analytics and Reporting",
      description: "Use data-driven insights to measure performance and refine marketing strategies."
    }
  ];
      ...
      <div className="row d-flex align-items-center justify-content-center mt-5 container-fluid">
        <div className="col-12 text-center">
          ...
          {/* <p className="text-uppercase text-primary">
            BEST Joomla WEBSITE DESIGN COMPANY IN NOIDA</p> */}
          ...
          Joomla
            ...
            Designs that Define and Deliver
            </span>
          </h3>

          {/* Description */}
          <p className="mt-4" style={{ textAlign: 'center', fontSize: "15px", lineHeight: "1.7" }}>
          Probey Services in Joomla, From SEO to social media marketing, Joomla provides comprehensive solutions tailored to meet the unique needs of each client.
          </p>
            ...
            <div className="row">
              <div className="col-md-6 border-right mb-3 mb-md-0" >
                <div className="">
                  ...
                  <span className="mt-2 w-75">Probey Services offers exceptional Joomla development services in Delhi NCR, dedicated to enhancing your business's online presence with expert Joomla solutions. Our experienced team builds high-performing, engaging Joomla websites optimized for SEO, positioning us among the top web development companies in India. We focus on ensuring your Joomla site ranks well on search engines like Google, making it easy for potential customers to discover your brand. More than just driving traffic, we specialize in converting visitors into loyal customers, helping your business grow efficiently. Let us elevate your Joomla site and turn your online presence into real, measurable results.</span>
                </div>
              </div>
